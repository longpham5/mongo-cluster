...
export const metadata: Metadata = {
  title: "Tempmail - Simple Temporary Email Service",
          ...
          <header className="backdrop-blur-sm bg-white/80 border-b border-slate-100 sticky top-0 z-40">
            <div className="container mx-auto px-4 h-16 flex items-center justify-between">
              <Link href="/" className="flex items-center gap-2" title="Home">
                ...
                <span className="font-medium text-lg text-slate-800">Temporary Email</span>
              </Link>
            ...
            <div className="container mx-auto px-4 max-w-5xl">
              <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-slate-600">Temporary Email</span>
                </div>
                
                <div className="text-center md:text-right">
                  <p className="text-sm text-slate-500">
                    Author <a href="https://t.me/longgg19999" className="text-indigo-600 hover:underline">LongPham</a>
                  </p>
                  <p className="text-xs text-slate-400 mt-1">
                    © {new Date().getFullYear()} Temporary Email - All rights reserved
                  </p>
                </div>
              </div>
            </div>
