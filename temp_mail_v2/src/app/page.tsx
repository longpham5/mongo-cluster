...
import { getServerDomains } from "@/lib/domains";
...
export default function Home() {
  // Get domains from runtime env
  const { domains, defaultDomain } = getServerDomains();
  const email = `${randomMail()}@${defaultDomain}`;
        ...
        <div className="overflow-hidden rounded-xl bg-white border border-slate-200 shadow-sm">
          ...
          <div className="p-5 space-y-4">
            <HomeInput 
              ...
              serverDefaultDomain={defaultDomain}
            />
          </div>
        </div>
      </section>
